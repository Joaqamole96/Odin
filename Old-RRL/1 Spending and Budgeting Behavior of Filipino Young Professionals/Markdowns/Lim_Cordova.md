...
Although their generation is heavily associated with extravagant and wasteful spending, they are also recognized for their alacrity to climb the career ladder for monetary goals and achievement recognition. With their varied life stages, careers, disposable incomes, and purchasing power, millennials predominantly navigate the Internet. This digital inclination spurred their prioritization of immediate experiences they gain using a trusted and friendly orientation towards technology [1-15].
...
Often assessed through statement responses and opinions, financial attitude is defined as how an individual feels about personal financial challenges, primarily influenced by his understanding of finances (Dai et al., 2021). A corpus of studies has empirically supported the essential significance of financial attitude in affecting individual financial management behaviours (Firli & Hidayati, 2021; Yanto et al., 2021; Dewi et al., 2020).
...
Financial efficacy, perceived to be an individual's confidence and ability to effectively deal with monetary stress and uncertainty, has long been linked with acquiring lower debt, fewer financial problems, higher savings, and financial satisfaction (Lim et al., 2014).
...
The study conducted an online survey within Laguna, Philippines, targeting a sample size of 431 millennials from various age groups, job types, and biological sexes. To comprehensively study millennials' financial decision-making, the data collection process included a custom survey questionnaire distributed through Google Forms with three main sections: general information, money management practices, and financial preparedness.

The general information section covered the respondents' demographic information. The money management section inquired about their spending habits.
...
The sample had a predominant representation of males (Males \(= 62.9\%\), Females \(= 37.1\%\), \(\mathrm{SD} = 0.484\)) while exhibiting a diverse monthly income (\(\mathrm{SD} = 1.52\)) with a substantial proportion earning between PHP 20,000 and PHP 26,999 (\(50.8\%\)) and having one to five years of experience (\(49.2\%\)).

With regard to age distribution, most of the respondents belong to the range of 26-27 years (\(\mathrm{SD} = 2.73\)) having job roles spanning multiple domains (\(\mathrm{SD} = 4.50\)), prominently in accounting and auditing (\(19.3\%\)), administrative (\(13.9\%\)), and banking and finance sectors (\(10.9\%\)). Diverse primary financial goals were apparent (\(\mathrm{SD} = 0.74\)) with wealth creation being the most prevalent among respondents (\(38.5\%\)).

**Table 1: Categorical Socio-demographic Characteristics of Respondents (N = 431)**
...
Proving to be an optimal framework for investigating complex connections between millennials' financial literacy, financial attitude, financial efficacy, and spending behavior, Structural Equation Modeling (SEM) possesses the capability to simultaneously explore complex associations among multiple variables, linking latent variables with observed variables. Given that the study investigates latent constructs inferred from observed variables, SEM's adeptness in handling latent variables ensures a more accurate representation.

Moreover, SEM accounts for measurement error in observed variables, crucial for counteracting potential biases in self-reported financial data. Fit indices help evaluate the overall appropriateness of the model, while SEM's capacity for hypothesis testing guarantees a rigorous investigation of specific hypotheses, providing an evidence-based understanding of the associations in question. Previous studies in the same area of research employed SEM to scrutinize complex relationships involving variables, such as consumer purchasing behavior, financial behavior, and financial capability (Arbabi et al., 2022; Hashmi et al., 2021; Cera et al., 2021), leveraging the technique's ability to deal with intricate models and explore nexus among dependent and independent variables.

Accentuating the importance of examining endogenous latent variables, such as financial literacy, financial attitude, financial efficacy, and spending behavior, the model incorporates a comprehensive set of three latent variables comprising aspects of financial behavior and attitudes shown in Table 2. Seven observed variables from financial literacy provide a comprehensive view of participants' financial knowledge by encompassing specific aspects like interest rates on savings, borrowing rates, credit ratings, and basic financial knowledge. Representing people's beliefs and actions related to budgeting, saving, goal-setting, and cost control, eight observed variables from financial attitude delve into individuals' beliefs and behaviors. Ten observed variables from financial efficacy constructs assess individuals' confidence in handling unforeseen costs, planning for retirement, managing finances, and tackling financial challenges.

Allowing for a more thorough analysis of millennials' financial behavior, nine observed variables examine spending patterns in terms of dining out, grocery, clothes, credit card payments, and recreational activities. All latent variables, such as financial literacy, financial attitude, financial efficacy, and spending behavior to be integrated in the model exhibited reasonable internal consistency reliability with Cronbach's alpha values of 0.971, 0.863, 0.858, and 0.656 and Variance Inflation Factor (VIF) values of 1.51, 2.54, and 2.72 respectively, indicating that constructs are distinct from each other and there is no severe multicollinearity issue in the model.

Upon garnering the mean scores of respondents in terms of financial literacy, financial attitude, and financial efficacy, they exhibited a moderately knowledgeable overall financial literacy level \(\mathrm{AVE} = 3.42\) with most agreeing to financial attitude \(\mathrm{AVE} = 3.69\) and financial efficacy statements \(\mathrm{AVE} = 3.56\)
...
When it came to financial efficacy, respondents demonstrated skill and confidence in managing their money, sticking to budgets, and achieving their financial goals, but expressed neutrality in terms of utilizing credit.
...
To closely analyze the spending patterns of millennials, a detailed breakdown of participants' spending behavior across various categories, along with corresponding standard deviations offering insights into the variability within each spending construct was created through computations from Jamovi in Tab. 3. In S1 (Percentage of spent income), \(42\%\) of participants reported spending \(41\%\) or more \(\mathrm{SD} = 1.495\). For S2 (Percentage of income spent on groceries), the majority \((77.5\%)\) allocated \(10\%\) or less \(\mathrm{SD} = 1.050\). S3 (Percentage of income spent on dining in or out) and S4 (Percentage of income spent on clothing, shoes, and accessories) depict similar patterns, with most respondents spending within lower ranges. S9 (Percentage of income spent on beer and wine) demonstrates high consistency, with \(93.7\%\) of respondents allocating \(10\%\) or less of their income to this category, revealing a prevalent and uniform spending pattern \(\mathrm{SD} = 0.521\).

In contrast, S5 (Percentage of income spent on credit card or loan payment) exhibits variability \(\mathrm{SD} = 0.993\), while S6 (Percentage of income spent on gas and car maintenance) shows moderate variability \(\mathrm{SD} = 0.625\). Both S7 (Percentage of income spent on travel or vacation) and S8 (Percentage of income spent on hobby and electronics) display similar patterns, with a majority of participants spending within lower percentage ranges \(\mathrm{SD} = 0.690\), \(0.629\).

The standard deviations obtained from the observed variables provide valuable information on the degree of variation or consistency in the spending habits of the participants in various categories of expenditure. A wide range of financial habits are suggested by the significant standard deviation in S1 (Percentage of spent income), which suggests significant variability in participants' total spending behavior. Furthermore, a more uniform pattern in this particular spending category is shown by the consistent and low standard deviation in S9 (Percentage of income spent on beer and wine), which may be a reflection of a solid and predictable component of participants' financial habits.

**Table 3: Frequency Table for Observed Variables of Spending Constructs**

| Observed Variable | 10% and less | 11%-20% | 21%-30% | 31%-40% | 41% and more |
|-------------------|--------------|---------|---------|---------|--------------|
| S1: Percentage of spent income | 58 (13.5) | 72 (16.7) | 63 (14.6) | 57 (13.2) | 181 (42) |
| S2: Percentage of income spent on groceries | 334 (77.5) | 72 (16.7) | 19 (4.4) | 4 (0.9) | 2 (0.5) |
| S3: Percentage of income spent on dining in or out | 334 (77.5) | 72 (16.7) | 19 (4.4) | 4 (0.9) | 2 (0.5) |
| S4: Percentage of income spent on clothing, shoes, and accessories | 348 (80.7) | 60 (13.9) | 19 (4.4) | 1 (0.2) | 3 (0.7) |
| S5: Percentage of income spent on credit card or loan payment | 291 (67.5) | 80 (18.6) | 33 (7.7) | 12 (2.8) | 15 (3.5) |
| S6: Percentage of income spent on gas and car maintenance | 352 (81.7) | 57 (13.2) | 16 (3.7) | 3 (0.7) | 3 (0.7) |
| S7: Percentage of income spent on travel or vacation | 346 (80.3) | 58 (13.5) | 19 (4.4) | 3 (0.7) | 5 (1.2) |
| S8: Percentage of income spent on hobby and electronics | 358 (83.1) | 55 (12.8) | 10 (2.3) | 4 (0.9) | 4 (0.9) |
| S9: Percentage of income spent on beer and wine | 404 (93.7) | 17 (3.9) | 4 (0.9) | 1 (0.2) | 5 (1.2) |

To gauge the suitability of identified variables, Confirmatory Factor Analyses (CFA) was conducted using Jamovi. Apparent in Tab. 3, the Root Mean Square Error of Approximation (RMSEA) values of 0.121, 0.150, 0.163, and 0.092 suggest a reasonable fit of the latent variables in the model.

The Tucker-Lewis Coefficient (TLI) and the Comparative Fit Index (CFI) values, which evaluate the extent to which the model reproduces relationships between variables, showed high values, suggesting great compatibility of the variables in the model. Other baseline comparison indices, such as the Standardized Root Mean Square Residual (SRMR), Akaike Information Criterion (AIC), and Bayesian Information Criterion (BIC), indicate an adequate balance of fit and complexity for financial literacy, financial attitude, financial efficacy, and spending.

**Table 4: Confirmatory Factor Analysis for Latent Variables**

| Latent Variable | Observed Variables | χ2 | df | RMSEA | TLI | CFI | SRMR | AIC | BIC |
|-----------------|--------------------|----|----|-------|-----|-----|------|-----|-----|
| Financial Literacy | FL1, FL2, FL3, FL4, FL5, FL6, FL7 | 102 | 14 | 0.121 | 0.933 | 0.955 | 0.031 | 871 | 277212 |
| Financial Attitude | FA1, FA2, FA3, FA4, FA5, FA6, FA7, FA8 | 214 | 20 | 0.150 | 0.809 | 0.864 | 0.069 | 280 | 418138 |
| Financial Efficacy | FE1, FE2, FE3, FE4, FE5, FE6, FE7, FE8, FE9, FE10 | 435 | 35 | 0.163 | 0.756 | 0.810 | 0.076 | 1100 | 2210144 |
| Spending | S1, S2, S3, S4, S5, S6, S7, S8, S9 | 127 | 27 | 0.092 | 0.847 | 0.885 | 0.058 | 781 | 678276 |

Note: χ2 = Chi-square, df = degree of freedom, RMSEA = Root mean square error of approximation, TLI = Tucker-Lewis coefficient, CFI = Comparative fit index, SRMR = Standardized Root Mean Square Residual, AIC = Akaike Information Criterion, BIC = Bayesian Information Criterion

Using Jamovi to construct a path diagram to visually depict a proposed financial behavior framework, the SEM includes four primary latent variables, namely Financial Literacy (FL), Financial Attitude (FA), Financial Efficacy (FE), and Spending (S) as shown in Figure 1. The observed indicators for each latent variable—financial literacy (FL1, FL2, FL3, FL4, FL5, FL6, and FL7), financial attitude (FA1, FA2, FA3, FA4, FA5, FA6, FA7, and FA8), financial efficacy (FE1, FE2, FE3, FE4, FE5, FE6, FE7, FE8, FE9, and FE10), and spending (S1, S2, S3, S4, S5, S6, S7, S8, and S9)—represent each latent variable.
...
![Figure 1: Path diagram of SEM model](image_placeholder_1)

> **Diagram text:** Path diagram showing four latent variables (Financial Literacy, Financial Attitude, Financial Efficacy, Spending) with observed indicators and arrows representing directional relationships. Standard path coefficients are annotated on the arrows.

Quantifying the strength and direction of relationships between key financial constructs, the parameter estimates shown in Tab. 3 provide significant insights contributing to an in-depth understanding of complex associations governing financial behavior. Among the noteworthy results are the strong positive correlations financial efficacy and financial literacy \(\mathrm{(b = 0.40142}\) \(\beta = 0.6136\) \(\mathrm{p}< .001)\), financial attitude and financial literacy \(\mathrm{(b = 0.36387}\), \(\beta = 0.5776\) \(\mathrm{p}< .001)\), and financial literacy and financial attitude \(\mathrm{(b = 0.36387}\) \(\beta\) \(= 0.5776\) \(\mathrm{p}< .001)\). Furthermore, a strong inverse relationship between spending and financial attitude is discovered \(\mathrm{(b = - 0.02963}\) \(\beta = - 0.1759\) \(\mathrm{p} = 0.034)\). Nevertheless, the relationships between spending and financial efficacy \(\mathrm{(b = - 0.02963}\) \(\beta = - 0.1759\) \(\mathrm{p} = 0.034)\) and spending and financial literacy \(\mathrm{(b = - 0.00871}\) \(\beta = - 0.0449\) \(\mathrm{p} = 0.477)\) are not statistically significant.

**Table 5: Parameter Estimates of Structural Paths (N = 431)**

| Structural paths | b | 95% confidence interval | β | p |
|------------------|----|-------------------------|----|----|
| Financial literacy | | | | |
| Financial efficacy ⇒ financial literacy | 0.40142 | [0.34979, 0.45305] | 0.6136 | < .001 |
| Financial attitude ⇒ financial literacy | 0.36387 | [0.30981, 0.41794] | 0.5776 | < .001 |
| Spending ⇒ financial literacy | -0.00871 | [-0.03270, 0.01529] | -0.0449 | 0.477 |
| Financial efficacy | | | | |
| Financial literacy ⇒ financial efficacy | 0.40142 | [0.34979, 0.45305] | 0.6136 | < .001 |
| Financial attitude ⇒ financial efficacy | 0.50478 | [0.45365, 0.55590] | 0.8882 | < .001 |
| Spending ⇒ financial efficacy | -0.01213 | [-0.03468, 0.01042] | -0.0693 | 0.292 |
| Financial attitude | | | | |
| Financial literacy ⇒ financial attitude | 0.36387 | [0.30981, 0.41794] | 0.5776 | < .001 |
| Financial efficacy ⇒ financial attitude | (not reported) | | | |
...
2. D. Andriani & N. Nugraha. IOP Conference Series. Earth and Environmental Science, 407(1), 12089 (2018).
3. F. Arbabi, S. Khansari, S. Aidin, A. Gholampour, P. Ebrahimi & M. Fekete-Farkas. Journal of Risk and Financial Management, 15(10), 1-21 (2022).
4. G. Çera, K. Khan, A. Mlouk & T. Brabeneck. Economic Research - Ekonomskalstraživanja, 34(1), 1265-1282 (2021).
5. K.L. Conley & J. L. Lusk. Applied Economic Perspectives and Policy, 41(1), 56-70 (2019).
6. B.J. Cude, S. Chatterjee & J. Tavosi. Review of Integrative Business and Economics Research, 10(3), 83-107 (2021).
7. A. Cwynar. Review of Economic Perspectives, 20(3), 289-335 (2020).
8. R.M. Dai, N. Kostini & P.V. Tresna. Review of Integrative Business and Economics Research, 10, 322-329 (2021).
9. V. Dewi, E. Febrian, N. Effendi & M. Anwar. Australasian Accounting, Business and Finance Journal, 14(4), 24-37 (2020).
10. A. Firli & N. Hidayati. Review of Integrative Business and Economics Research, 10, 43-55 (2021).
11. E. Hashim, N. Rambeli, H. Asmawi & A.J. Norasibah. NeuroQuantology, 20(6), 34 (2022).
12. F. Hashmi, H. Aftab, J. M. Martins, M. Nuno Mata, H.A. Qureshi, A. Abreu & P.N. Mata. PloS One, 16(9) (2021).
13. S. Ismail, F.A. Faique, M. H. Bakri, Z.M. Zain, N.H. Idris, Z.A. Yazid & N.M. Taib. Advanced Science Letters, 23(5), 4635-4639 (2017).
14. E. Ketter. Journal of Tourism Futures, 7(2), 192-196 (2020).
15. K.T. Kim, S.G. Anderson & M.C. Seay. Journal of Family and Economic Issues, 40(2), 194-208 (2019).
16. L.R. Larson, J.K. Eastman & D.E. Bock. Journal of Marketing Theory and Practice, 24(1), 72-90 (2016).
17. H. Lim, S. Heckman, C.P. Montalto & J. Letkiewicz. Journal of Financial Counseling and Planning, 25(2), 148-160 (2014).
18. R. Mindra, M. Moya, L.T. Zuze & O. Kodongo. International Journal of Bank Marketing, 35(3), 338-353 (2017).
19. A. Mohta & V. Shunmugasundaram. International Journal of Economics and Financial Issues, 12(2), 61-66 (2022).
20. A. Murray. Applied Economics Letters, 28(15), 1277-1282 (2021).
21. Z. Ramli, H.B. Nyirop, S.M. Sum & A.H. Awang. Sustainability (Basel, Switzerland), 14(8), 4836 (2022).
22. A.M. Rappaport & M. Stone. Benefits Quarterly, 35(4), 18-6 (2019).
23. L. Rey-Ares, S. Fernández-López, S. Castro-González & D. Rodeiro-Pazos. Journal of Behavioral and Experimental Economics, 93, 101702 (2021).
24. L. Rutherford & S.A. DeVaney. Journal of Financial Counseling and Planning, 20(2) (2009).
25. M.T.G. Salumintao & M.F. Cinches. Journal of Institutional Research South East Asia, 17(1) (2019).
26. M.N. Seldal & E.K. Nyhus. Financial vulnerability, financial literacy, and the use of digital payment technologies. Journal of Consumer Policy, 45(2), 281-306 (2022).
27. R.S. Sethi, J. Kaur & D. Wadera. Academy of Marketing Studies Journal, 22(1), 1-16 (2018).
28. M. Setiawan, N. Effendi, T. Santoso, V.I. Dewi & M.S. Sapulette. Economics of Innovation and New Technology, 31(4), 320-338 (2022).
29. V. Sotiropoulos & A. d'Astous, Journal of Consumer Policy, 36(2), 179-196 (2013).
30. R. Tiongson. Financial education and the Filipino millennial. Inquirer. https://business.inquirer.net/421941/financial-education-and-the-filipino-millennial (2023, September 20).
31. D. Ushakov, V. Bandurin & A. Bandurin, A. Montenegro Journal of Economics, 13(1), 171-179 (2017).
32. D. Ushakov, M. Vinichenko & E. Frolova. IOP Conference Series: Earth and Environmental Science, 272(3), 032111 (2019).
33. D. Ushakov, E, Dudukalov, L. Shmatko & K. Shatila. Transportation Research Procedia, 63, 2401-2408 (2022).
34. J.C. Velasco & J. De Chavez. Mediterranean Journal of Social Sciences, 9(6), 121 (2018).
35. I. Widjaja, A. Arifin & M. Setini. Management Science Letters, 10(15), 3635-3642 (2020).
36. H. Yanto, N. Ismail, K. Kiswanto, N.M. Rahim & N. Baroroh. Cogent Social Sciences, 7(1), 1947579 (2021).
37. R. Yao & G. Cheng. Family and Consumer Sciences Research Journal, 46(2), 110-128 (2017).
38. C. Yoopetch & P. Chaithanapat. Kasetsart Journal of Social Sciences, 42(3), 501-508 (2021).