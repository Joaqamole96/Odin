...
International if: foreign/global research paper.
...
4. Determine **Designation?** – local/international with justification.
5. Determine **Algorithm-specific?** – yes/no with justification.
...
- [#] Author et al. (Year)
  ...
  - Algorithm-specific: ❌ [reason, e.g., only Spearman]
...
- [3] Laspinas & Murcia (2024)
  - Designation: ❌ Published inside the Philippines
