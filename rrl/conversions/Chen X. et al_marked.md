...
Xi Chen 1 Yateng Tang2 Jiarong Xu 3 Jiawei Zhang 4 Siwei Zhang 1 Sijia Peng 1 Xuehao Zheng 2 Yun Xiong 1
Abstract
...
1
arXiv:2505.00887v2  [cs.LG]  14 May 2025
...
Patterns 
Capturing Pre-defined Pre-defined Diverse
Formula
Architecture
TE(t)[i]=Emonth(tmonth)[i]+Eday(tday)[i]+
Eweekday(tweekday)[i]+Ehour(thour)[i]+Emin(tmin)[i] TE(t)[i]=si⋅LayerNorm(ϕi(ωit+φi))TE(t)[i]={
sin(ωit+φi) or ωit+φi,if i=1,
sin(ωit+φi), if 2≤i≤d
(a) (b) (c)Time Embedding
t
Fixed Non-linear  
Transformation
(ωit+φi)
...
Extract Features
t
[tmonth,tday,tweekday,thour,tminute]
Time Embedding
Embedding and  
Element-wise Addition
Linear Transformation
Time Embedding
Learnable Non-linear 
Transformation
t
...
Combined LeTE
t
[si]⋅LayerNorm[ϕi(ωit+φi)]
xi=ωit+φiFourier-based Spline-based
ϕ1(x1)=a0+
K
∑k=1
(akcos(kx1)+bksin(kx1))
...
KX
k=1
(ak cos(kx) + bk sin(kx)) , (7)
where a0, ak, and bk are the parameters to be learned, andK
...
and incorporating different harmonicsk, the function can ap-
...
the sine function, respectively. By selectingK =1, ai,0 = 0,
...
MAE Transformer Pyraformer NS Trans. MINC TimesNet Win
...
Electricity720 0.374 0.453 0.363 0.390 0.394 0.380 0.321 0.330 0.317 0.321 0.330 0.317 0.320 0.363 0.316
100%
...
Exchange720 1.329 1.147 1.066 1.075 1.046 0.938 0.769 0.901 0.612 0.658 0.710 0.622 0.746 0.756 0.751
95%
...
Weather720 0.690 0.459 0.429 0.434 0.417 0.415 0.410 0.357 0.349 0.356 0.387 0.339 0.359 0.350 0.348
100%
Win Rate 100% 94% 100% 100% 94% 98%
...
LeTE 99.13 ± 0.02 98.73 ± 0.00 99.24 ± 0.01 98.86 ± 0.01 88.70 ± 0.21 88.39 ± 0.15 93.64 ± 0.10 94.69 ± 0.12
...
Hagenmeyer, V ., and Mikut, R. Intrinsic explainable
...
Rethinking Time Encoding via Learnable Transformation Functions
Under these conditions, the Fourier Series converges tof (x) at all points where f is continuous and converges to the average
...
C.1.1. D ETAILS OF FUNCTIONAL TIME REPRESENTATION AND TIME 2V EC
...
encoding.
T2V is designed to use timestampst as input. A linear transformation is applied to the first dimension to capture non-periodic
...
C.1.2. P ROOF OF PROPOSITION 2.1
...
sin(ωit) = sin (ωit + 0) , for i = 1, 2, . . . , d. (27)
...
interval [a, b].
B-spline basis functions of degree k form a basis for the space of piecewise polynomial functions of degreek with continuity
...
A class C of models is considered invariant to time rescaling if, for any model M1 ∈ Cand any scalar α >0, there exists a
model M2 ∈ Cthat responds to αt (where t is scaled by α) in the same way that M1 responds to the original t values. We
...

+ bj, (34)
where i = 1, 2, . . . , Dindexes the input dimension, j = 1, 2, . . . , Mindexes the output dimension (with D = M in our
method), and m = 1, 2, . . . , Kindexes the Fourier frequencies. Here, K is a hyper-parameter that determines the grid size.
...
E.2.1. E XPERIMENT IMPLEMENTATION DETAILS
...
E.3.1. E XPERIMENT IMPLEMENTATION DETAILS
...
• TGA T(Xu et al., 2020) introduces a temporal attention mechanism to aggregate information from temporal-topological
...
Dataset Dimn Dime # Nodes # Edges Information Duration Time Granularity
...
MSE Transformer Pyraformer NS Trans. MICN TimesNet Win
TE HCTE FTE LeTE HCTE FTE LeTE HCTE FTE LeTE HCTE FTE LeTE HCTE FTE LeTE Rate
...
Electricity720 0.288 0.395 0.276 0.304 0.304 0.293 0.222 0.237 0.226 0.212 0.228 0.208 0.220 0.287 0.220
95%
...
Exchange720 2.569 2.002 1.736 1.762 1.714 1.316 1.092 1.546 0.682 0.714 0.833 0.636 0.964 0.989 0.958
95%
...
Weather720 0.844 0.480 0.425 0.411 0.394 0.383 0.414 0.350 0.338 0.311 0.350 0.303 0.365 0.354 0.352
95%
Win Rate 100% 94% 94% 94% 94% 95%
...
TE Transductive Inductive Transductive Inductive Transductive Inductive Transductive Inductive
TGAT FTE 96.69 ± 0.26 95.95 ± 0.33 98.48 ± 0.04 96.90 ± 0.07 86.44 ± 0.24 86.04 ± 0.19 70.89 ± 0.10 76.11 ± 0.11
LeTE 97.63 ± 0.11 97.07 ± 0.10 98.51 ± 0.01 96.96 ± 0.05 89.46 ± 0.08 89.50 ± 0.05 74.24 ± 0.28 79.63 ± 0.14
TGN FTE 98.37 ± 0.07 97.72 ± 0.03 98.60 ± 0.06 97.39 ± 0.07 91.21 ± 1.15 91.24 ± 0.99 78.47 ± 2.94 82.61 ± 3.15
LeTE 98.73 ± 0.07 98.11 ± 0.10 98.72 ± 0.00 97.55 ± 0.05 92.68 ± 0.37 92.41 ± 0.73 83.94 ± 1.85 87.74 ± 1.75
TCL FTE 95.84 ± 0.18 95.57 ± 0.20 97.42 ± 0.02 93.80 ± 0.07 83.12 ± 0.18 81.43 ± 0.19 64.06 ± 1.16 70.84 ± 0.85
...
LeTE 99.04 ± 0.01 98.67 ± 0.02 99.17 ± 0.00 98.74 ± 0.01 89.18 ± 0.21 89.16 ± 0.30 93.65 ± 0.07 94.52 ± 0.08
19
...
MAE Transformer Pyraformer NS Trans. MINC TimesNet
...
prediction length combinations are in bold.
MSE Transformer Pyraformer NS Trans. MINC TimesNet
TE HCTE FTE LeTE HCTE FTE LeTE HCTE FTE LeTE HCTE FTE LeTE HCTE FTE LeTE
ETTm1
...
The magnitudes are then normalized to form a probability distribution: P (f ) = M (f )P
f M (f ). Finally, the spectral entropy
is computed as: H(P ) = − P
f P (f ) logP (f ), which measures the uniformity of the frequency components. A lower
...
1.0
1.2Density
Density Plot of Spectral Entropy (Timestamp of Interactions)
Wikipedia
Reddit
Mooc
Lastfm
...
1.0
1.2Density
Density Plot of Spectral Entropy (Time Difference between Interactions)
Wikipedia
Reddit
Mooc
Lastfm
...
Former
FTE 99.03 ± 0.02 98.59 ± 0.03 99.22 ± 0.01 98.84 ± 0.02 87.52 ± 0.49 86.96 ± 0.43 93.00 ± 0.12 94.23 ± 0.09
F-LeTE 99.04 ± 0.01 98.66 ± 0.05 99.22 ± 0.01 98.85 ± 0.02 87.60 ± 0.26 87.15 ± 0.22 93.06 ± 0.05 94.11 ± 0.09
S-LeTE 99.12 ± 0.01 98.72 ± 0.03 99.17 ± 0.10 98.78 ± 0.13 88.66 ± 0.20 88.37 ± 0.25 93.50 ± 0.12 94.57 ± 0.15
...
Former
FTE 98.91 ± 0.02 98.48 ± 0.03 99.15 ± 0.01 98.71 ± 0.01 87.91 ± 0.58 87.62 ± 0.51 93.05 ± 0.10 94.08 ± 0.08
F-LeTE 98.94 ± 0.02 98.55 ± 0.03 99.16 ± 0.01 98.72 ± 0.03 88.09 ± 0.16 87.89 ± 0.14 93.09 ± 0.03 94.00 ± 0.04
S-LeTE 99.04 ± 0.01 98.67 ± 0.02 99.08 ± 0.13 98.61 ± 0.19 89.18 ± 0.21 89.16 ± 0.30 93.56 ± 0.06 94.46 ± 0.06
...
Magnitude (x'_0)
Magnitude (x'_1) (b) Dim 1 (Fourier-based)
