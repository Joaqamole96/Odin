...
conversion_metadata:
  ...
  source_pdf_sha256: "63f0aaeadaea4338a4fde7c0b3f74d530cdb49979fe732c178c5041fdc128c3f"
  page_count: 44
  markdown_char_count: 91605
---

Do Remittances Boost Household Spending: New Evidence from
Migrants’ Household Survey
Veronica B. Bayangosa*
Cymon Kayle Lubangcob*
a Office of the Governor and Office of Systemic Risk Management, Bangko Sentral ng
Pilipinas, A. Mabini St. cor. P. Ocampo St., Malate, Manila, Philippines 1004,
VBayangos@bsp.gov.ph | (63 2) 8811 1277
b BSP Research Academy, Bangko Sentral ng Pilipinas, A. Mabini St. cor. P. Ocampo St.,
Malate, Manila, Philippines 1004, LubangcoC@bsp.gov.ph | (63 2) 8811 1277
* Corresponding authors emails: VBayangos@bsp.gov.ph
LubangcoC@bsp.gov.ph

Acknowledgements
We are grateful for the comments given by our colleagues from the BSP Research Academy,
the ASEAN+3 Macroeconomic Research Office, and our roundtable panelists, Dr. Alvin P.
Ang, Dr. Geoffrey Ducanes, and Assistant Secretary Levinson Alcantara. The views expressed
in this discussion paper are those of the authors and do not represent the official position of the
...
Migrants’ Household Survey
Abstract
This study examines the impact of remittances on household spending in the Philippines, a
major remittance-receiving country. Utilizing unique surveys of migrant households and
financial institutions, we provide a nuanced analysis of how remittances shape consumption
patterns across income groups. While remittances generally enhance household spending, we
find that financial constraints remain binding for poorer households, limiting the potential
welfare gains. Beyond household-level dynamics, we identify key macroeconomic and
structural factors influencing remittance flows. Our findings reveal that remittance growth is
driven by the number of overseas workers, domestic unemployment rates, and peso
depreciation, while higher regional wages and transaction costs act as deterrents. The findings
provide valuable insights for policymakers seeking to optimize the developmental impact of
remittances.
Keywords: Remittances, household spending, migration

1. Introduction
The impact of remittances on household welfare and economic development has been
extensively studied, yet gaps remain in our understanding of the nuanced relationship between
remittance inflows, household consumption patterns, and the macroeconomic factors that shape
these flows. While previous research has established a positive link between remittances and
consumption in many developing countries, the specific mechanisms through which
remittances affect household spending decisions, and the factors driving remittance flows,
remain subjects of ongoing debate. This study contributes to this literature by providing new
evidence from the Philippines, a major remittance-receiving country, on the impact of
remittances on household spending and the factors influencing remittance inflows. We address
two key research questions: (1) Do remittances significantly influence household spending
patterns in the Philippines? (2) What are the key macroeconomic and financial drivers of
remittance inflows into the country? Using a combination of household survey data and
financial sector information, we offer fresh insights into these questions, with implications for
policy interventions aimed at maximizing the development impact of remittances.
...
Philippines.
To address our first research question, we analyzed data from the Survey on Overseas
Filipinos (SOF) from 2007-2022, exploring remittance dynamics at household and regional
levels. We used logistic regressions to assess the patterns of remittance use among households
left behind by OFWs, supplemented by data from the Family Income and Expenditure Survey
(FIES). To answer the second research question, we estimated factors influencing regional
remittance inflows using a panel generalized method of moments (GMM). This analysis was
informed by an annual survey (2015-2023) of the financial costs of sending remittances to the
...
representative annual migrant household survey conducted by the PSA that captures the
information of OFs who left the Philippines within five years prior to the reference period.
...
about 57.2 percent of the total cash remittances were sent by OFWs through banks while cash
remittances through money transfer services or through non-banks was at 41.2 percent. Around
1.6 percent of the cash remittances sent by the Filipinos working in other countries were sent
through agency/local office of the OFW, friends/co-workers, door to door, and others.
INSERT FIGURE 1
As shown in Figure 2, Region IV-A or CALABARZON has the largest proportion of OFWs
at 15.3 percent of the estimated 1.96 million OFWs in 2022. This was followed by Central

Luzon or Region III (13.3 percent), Western Visayas or Region VI (11.1 percent), National
Capital Region (10.9 percent), and Ilocos Region or Region I (9.1 percent).
INSERT FIGURE 2
...
a. Remittance-receiving households give greater priority to immediate consumption
over saving and investing
Figure 4 shows the average saving and investing rate of OFW households. We discovered
that, on average, OFW households tend to allocate cash remittances to-wards savings than on
investments. The saving rate for cash remittances peaked in 2009, where an average of 13.1
percent of cash remittances were allocated for savings. Since 2009, the average saving rate for
cash remittances among OFW households has slightly declined to around 9.0-10.0 percent.
Overall, the average saving rate from 2008 to 2022 is at 9.9 percent.
...
(Figure 5d). While OFW households tend to allocate cash remittances toward savings than
investments, the overall narrative on the OFW households’ immediate spending pattern over
time specifically starting 2015 may be relatively stable but soft.
INSERT FIGURE 5
b. Migration status and migrants’ educational attainment affect households’
remittance receipt allocation decisions
...
OFW households tend to save more than households with immigrant members.
INSERT TABLE 1
...
c. Migrant households’ immediate consumption tends toward non-food
consumption, but financial constraints remain binding
We turn to the item-by-item consumption decision of migrant households using the
information in the FIES. Figure 6 shows that on average, pre-Covid expenditures are higher
across households, and migrant households tend to have higher expenditures than non-migrant
households. In absolute terms, food consumption is higher for migrant households than non-
migrant households, which is consistent with what is previously observed in the Philippines by
Murakami, Shimizutani, and Yamada (2021).
...
(Mishra et al. 2022; Kamal and Rana, 2019; Wang et al. 2019) for as long as migrant households
are not poor. However, these studies do not distinguish the effects among different non-food
items. We take advantage of the disaggregated non-food items in the FIES to assess the effects
of remittances on consumption spending of poor and non-poor remittance-receiving
households. However, endogeneity issues might arise since a reverse causation may exist
between remittances and household expenditures, such as what is demonstrated in Mishra et
al. (2022) and Ajefu and Ogebe (2020). The difficulty with addressing endogeneity is that
identifying an instrument that only affects remittance receipts and not household consumption
may be challenging either because of weak instruments or data constraints. In the absence of a
feasible set of instrumental variables, we follow Randazzo and Piracha (2019) in assessing how
remittances affect household spending behavior. In the absence of strong and reliable
instruments, we estimate the average treatment effect through a propensity score matching
(PSM) technique (Randazzo and Piracha 2019). This method assesses the difference between
the average expenditure behavior of remittance-receiving households with the non-receiving
households. Further, since we are interested at the marginal expenditure behavior of
households, we implement the Working-Leser model. Following Randazzo and Piracha (2019),
we use the following specification:
𝑌 = 𝛽 +𝛽 ln𝑐𝑜𝑛𝑠 +𝑿𝑻𝜸+𝜃 𝑅 +𝜀 (1)
𝑖𝑗 0 1 𝑗 𝑖 𝑑𝑗 𝑖𝑗
where 𝑌 is the budget share for a good 𝑖 of household 𝑗, ln𝑐𝑜𝑛𝑠 is the natural logarithm of
𝑖𝑗 𝑗
total household expenditure, 𝑿𝑻 are the control covariates, 𝑅 and pertains to the dummy
𝑑𝑗
...
educational attainment. Table 3 shows these results.
INSERT TABLE 3
Building on existing literature, our findings provide a more nuanced understanding of how
remittances reshape household spending patterns across income groups. While remittance-
receiving households generally allocate more to non-food expenditures, this shift is
significantly more pronounced among wealthier households. Notably, non-poor households
channel remittances toward education, health, and housing, reinforcing long-term investments
in human capital and living standards. Interestingly, remittances appear to reduce durable goods
expenditures among non-poor households, while for poor households, remittance receipt does
not alter their spending on durables. This suggests that remittances may serve different
functions depending on a household’s economic status—facilitating investment-oriented
spending for wealthier households while covering essential needs for poorer ones. This also
suggests that financial constraints faced by poor households seem to be binding. This can be
seen with the weaker consumption shifts among poor households. Annex A also provides
further discussion on how financial constraints are binding for poorer households even if we
account for the spillover effects of remittances non-recipient households.
...
banking financial institutions of the BSP, Figure 7 and Figure 8 show the average financial cost
...
intermediary fees are included in telegraphic transfers. Figure 8 shows that remittances from
...
demonstrated in the studies of Kamal and Rana (2019), Wang et al. (2019), and Mishra et al.
(2022) on migrant households in Bangladesh, Kyrgyzstan, and Nepal, respectively. With this,
a crucial question arises: Will OFW households’ consumption spending—a crucial component
of the national expenditure account—hold up over the medium run?
...
𝑅𝑒𝑚𝑖𝑡 = 𝛽 +𝛽 𝑅𝑒𝑚𝑖𝑡 +𝛽 𝐺𝑅𝐷𝑃𝑝𝑐 +𝛽 𝑂𝐹𝑊 +𝛽 𝑤𝑎𝑔𝑒
𝑖𝑡 1 2 𝑖𝑡−1 3 𝑖𝑡 4 𝑖𝑡 5 𝑖𝑡
+𝛽 𝜋 +𝛽 𝑢𝑛𝑒𝑚𝑝𝑙𝑜𝑦𝑚𝑒𝑛𝑡 +𝛽 𝑓𝑜𝑟𝑒𝑥 +𝛽 𝑐𝑜𝑠𝑡 (2)
6 𝑖𝑡 7 𝑖𝑡 8 𝑡 9 𝑡
+𝜀
𝑖𝑡
...
greater than the number of regressors. Table 4 shows the descriptive statistics for the covariates
...
specifications of the model. Columns (1) to (3) of cash and personal remittances in Table 5
...
may increase. Annex B also provides an alternative specification for land- and sea-based
remittances.

6. Conclusion
This study has provided new insights into the complex relationship between remittances
and household spending in the Philippines, a country heavily reliant on remittances for
economic stability. Our findings underscore the critical role remittances play in supporting
household consumption, particularly in areas such as health, education, and housing. The
altruistic nature of remittances is evident, as they serve as a vital safety net during economic
downturns. However, the impact of remittances on household welfare is influenced by various
macroeconomic and financial factors, including transaction costs, exchange rates, and regional
economic conditions. At the household level, the financial status of families may also prove to
be a binding constraint, which may enfeeble the welfare improving benefits of remittances.
This implies a cautionary note on treating remittances as panacea to poverty and other welfare
issues.
From a policy perspective, our results suggest several key strategies to enhance the
developmental impact of remittances. Firstly, reducing transaction costs in formal remittance
channels is crucial to encourage the use of regulated and secure channels, thereby increasing
financial inclusion and reducing the reliance on informal networks. Secondly, promoting
financial literacy among remittance-receiving households can help optimize the allocation of
remittances towards savings and investments, fostering long-term economic resilience. Lastly,
policymakers should consider implementing targeted social safety nets to support remittance-
receiving households during periods of economic instability, ensuring that the benefits of
remittances are maximized for household welfare and national development.
While this study contributes significantly to our understanding of remittances in the
Philippines, there are avenues for future research. Investigating the long-term effects of
remittances on asset accumulation and intergenerational mobility, as well as exploring the
heterogeneous impacts across different sectors and skill levels of overseas Filipino workers,

would provide a more comprehensive picture of the migration-remittance-development nexus.
Additionally, examining the welfare implications of rising migration costs and the increasing
reliance on debt to finance migration could offer valuable insights for policymakers seeking to
support sustainable migration and development outcomes.
In conclusion, remittances are a vital component of the Philippine economy, offering both
immediate support for household consumption and potential for long-term economic growth.
By addressing the challenges and opportunities associated with remittances, policymakers can
harness their full potential to promote inclusive development and enhance the well-being of
remittance-receiving households.
References
Adenutsi, D. & Ahortor, C. (2021). Macroeconomic determinants of remittance flows to sub-
Saharan Africa. [African Economic Research Consortium Research Paper No. 415].
https://aercafrica.org/old-website/wp-content/uploads/2021/01/Research-Paper-415.pdf
Agarwalla, S. K., Barua, S. K., Jacob, J., & Varma, J. R. (2013). Financial literacy among
working young in urban India. World Development, 67, 101–109.
https://doi.org/10.1016/j.worlddev.2014.10.004
Ajefu, J. & Ogebe, J. (2020). The effects of international remittances on expenditure patterns
of the left-behind households in Sub-Saharan Africa. Review of Development Economics,
25(1), 405–429. https://doi.org/10.1111/rode.12721
Akobeng, E. (2022). Migrant remittances and consumption expenditure under rain-fed
agricultural income: Micro-level evidence from Ghana. Oxford Development Studies,
50(7). https://doi.org/10.1080/13600818.2022.2077924
Amuedo-Dorantes, C. & Pozo, S. (2011). Remittances and income smoothing. American
Economic Review, 101(3), 582–587. https://doi.org/10.1257/
aer.101.3.582
...
https://doi.org/10.1093/oep/gpx035

Bangko Sentral ng Pilipinas. (2024). Statistics – external accounts: Overseas Filipinos’
remittances. https://www.bsp.gov.ph/
SitePages/Statistics/External.aspx?TabId=8
Bedi, A. S., Calero, C., & Sparrow, R. (2009). Remittances, liquidity constraints, and human
capital investments in Ecuador. World Development, 37(6), 1143–1154.
https://doi.org/10.1016/j.worlddev.2008.10.006
Bunduchi, E., Vasile, V., Comes, C., & Stefan, D. (2019). Macroeconomic determinants of
remittances: Evidence from Romania. Applied Economics, 51(35), 3876–3889.
https://doi.org/10.1080/00036846.2019.1584386
Chai, A. & Moneta, A. (2010). Retrospectives: Engel curves. Journal of Economic
Perspectives, 24(1), 225–240. https://doi.org/10.1257/jep.24.1.225
De, S., Islamaj, E., Kose, M., & Yousefi, S. (2019). Remittances over the business cycle:
Theory and evidence. Economic Notes, 48(3). https://doi.org/10.1111/ecno.12143
Dhakal, S. & Oli, S. (2020). The impact of remittance on consumption and investment: A case
of province five of Nepal. Quest Journal of Management and Social Sciences, 2(1), 35–
49.
Docquier, F. & Rapoport, H. (2006). In S. Kolm & J. Ythier (Eds.), Handbook on the economics
of giving, reciprocity, and altruism (Vol. 1, pp. 1135–1198). Elsevier.
Duval, L. & Wolff, F. (2016). Do remittances support consumption during crisis? Evidence
from Kosovo. Oxford Development Studies, 44(4), 1–14.
http://dx.doi.org/10.1080/13600818.2016.1156080
Georgiou, M. C. (2015). Reflections: A case for mandating personal finance in high school.
Journal of Family & Consumer Sciences, 107(1), 64–68.
Haider, M., Hossain, T., & Siddiqui, O. (2016). Impact of remittance on consumption and
savings behavior in rural areas of Bangladesh. Journal of Business, 1(4).
https://doi.org/10.18533/job.v1i4.49
...
Kamal, M. & Rana, E. (2019). Do internal and international remittances affect households’
expenditure and asset accumulation differently? Evidence from Bangladesh. Journal of
Developing Areas, 53(2), 139–153.
...
Mahapatro, S. (2017). Why do they remit? Examining factors influence migrant remittances in
India. Journal of Development Policy and Practice, 2(2).
https://doi.org/10.1177/2455133317704745

Mandelman, F. & Zlate, A. (2012). Immigration, remittances, and business cycles. Journal of
Monetary Economics, 59(2), 196–213. https://doi.org/10.1016/j.jmoneco.2012.01.004
Mishra, K., Kondratjeva, O., & Shively, G. (2022). Do remittances reshape household
expenditures? Evidence from Nepal. World Development, 157. https://
doi.org/10.1016/j.worlddev.2022.105926
...
Economics of Disasters and Climate Change, 5, 97–110. https://doi.org/10.1007/s41885-
020-00078-9
Odhiambo, N. & Nyasha, S. (2020). Financial development and economic growth in Uganda:
A multivariate causal linkage. Journal of African Business, 23(2), 361–379.
https://doi.org/10.1080/15228916.2020.1838834
Philippine Statistics Authority. 2019. 2019 Survey on Overseas Filipinos (SOF).
Ramcharran, H. (2020). Analyzing the impact of workers’ remittances on household
consumption in Latin American and Caribbean countries. Journal of Economics and
Finance, 44(1), 59–77. https://doi.org/10.1007/s12197-019-9468-z
Randazzo, T. & Piracha, M. (2019). Remittances and household expenditure behaviour:
Evidence from Senegal. Economic Modelling, 79, 141–153.
https://doi.org/10.1016/j.econmod.2018.10.007
...
Working Paper Series 5558]. https://ideas.repec.org/
p/wbk/wbrwps/5558.html
...
Rosenzweig, M. & Stark, O. (1989). Consumption smoothing, migration, and marriage:
Evidence from rural India. Journal of Political Economy, 97(4),
905–926. https://www.jstor.org/stable/1832196
Tuaño-Amador, M., Bayangos, V., Romarate, M., & Maliwat, C. (2022). Remittances from
overseas Filipinos in the time of COVID-19: Spillovers and policy imperatives. [BSP
Discussion Paper No. 2022-010].
https://www.bsp.gov.ph/Pages/MediaAndResearch/PublicationsAndReports/Discussion
%20Papers/DP202201.pdf
Wang, D., Hagedorn, A., & Chi, G. (2019). Remittances and household spending strategies:
Evidence from the Life in Kyrgyzstan Study, 2011–2013. Journal of Ethnic and
Migration Studies, 47(13), 3015–3036. https://doi.org/10.1080/
1369183X.2019.1683442
World Bank. (2024). Migration and development brief 40: Remittances slowed in 2023,
expected to grow faster in 2024. World Bank Group.

Yameogo, N. (2014). Analysis of household expenditures and the impact of remittances using
a latent class model: The case of Burkina Faso. [African Development Bank Group
Working Paper Series No. 2014-200].
www.afdb.org/fileadmin/uploads/afdb/Documents/Publications/Working_Paper_200_-
_Analysis_of_Household_Expenditures_and_the_Impact_of_
Remittances_using_a_Latent_Class_Model-_the_Case_of_Burkina_Faso.pdf
Yin, Y., Qamruzzaman, M., Xiao, H., Mehta, A., Naqvi, F., & Baig, I. (2022). Nexus between
uncertainty, remittances, and household consumption: Evidence from dynamic SUR
application. Frontiers in Environmental Science, 10,
1–14. https://doi.org/10.3389/fenvs.2022.950067.
Yoshino, N., Taghizadeh-Hesary, F., Otsuka, M. (2017). International remittances and poverty
reduction: Evidence from Asian developing countries. [ADBI Working Paper No. 759].
https://www.adb.org/sites/default/files/publication/
329191/adbi-wp759.pdf
Endnotes
...
List of Figures
Figure 1. Distribution of OFWs across Different Age Groups, 2007–2022. (Source of basic
data: Authors’ calculations; Philippine Statistics Authority)
Figure 2. OFW Region of Residence, 2007–2022. (Source of basic data: Authors’
calculations; Philippine Statistics Authority)

Figure 3. OFW Countries and Regions of Destination, 2007–2022. (Source of basic data:
Authors’ calculations; Philippine Statistics Authority)
Figure 4. Spending and Saving Behavior of OFW Recipient Households, 2008–2022. (Source
of basic data: Authors’ calculations; Philippine Statistics Authority)

Figure 5. Pooled Distribution of OFW Households and their Allocation Rates for Cash
Remittances towards: (a) Saving, (b) Investing, (c) Immediate Consumption, and (d) Gifts
and Donations, 2008–2022. (Source of basic data: Authors’ calculations; Philippine Statistics
Authority)
Figure 6. Average household total expenditures and expenditures in selected commodities of
migrant and non-migrant households in (a) 2018 and (b) 2021 (in PHP). (Source of basic
data: Authors’ calculations; Philippine Statistics Authority)

Figure 7. Average Financial Costs of Sending Remittances from Abroad to any Point in the
Philippines by Banks and Non-Banks (Outgoing Remittances) as a Ratio of Average Cash
Remittances per OFW Worker, 2007–2022. (Source of basic data: Authors’ calculations)
Figure 8. Average Financial Costs of Sending Remittances from Abroad to the Philippines by
...
Table 1. Comparison of Average Saving, Investing, and Consumption Rate across
Different Migrant Characteristics
|     |     | Sample  |     | Saving  | Investing  |     | Consumption  |
| --- | --- | ------- | --- | ------- | ---------- | --- | ------------ |
|     |     | Size    |     | Rate    |    Rate    |     | Rate         |
A. Overseas Filipino
| status                |     |         |           |         |        |     |          |
...
Table 3. Consumption Behavior of Remittance-Receiving Poor and Non-Poor
Households (standard errors in parenthesis)
Consumption as share of total
Average treatment effects on remittance-
| expenditure  |     |     |     | receiving households  |     |     |
| ------------ | --- | --- | --- | --------------------- | --- | --- |
...
| Education  |     |     | 0.0002  |     | 0.0040***  |     |
| ---------- | --- | --- | ------- | --- | ---------- | --- |

|     |     |     | (0.0003)  |     | (0.0003)  |     |
| --- | --- | --- | --------- | --- | --------- | --- |

| Health  |     |     | 0.0011***  |     | 0.0050***  |     |
| ------- | --- | --- | ---------- | --- | ---------- | --- |

|     |     |     | (0.0004)  |     | (0.0004)  |     |
| --- | --- | --- | --------- | --- | --------- | --- |

| Clothing  |     |     | 0.0011***  |     | 0.0009***  |     |
| --------- | --- | --- | ---------- | --- | ---------- | --- |

|     |     |     | (0.0002)  |     | (0.0001)  |     |
| --- | --- | --- | --------- | --- | --------- | --- |

| Housing and utilities   |     |     | 0.0106***  |     | 0.0204***  |     |
| ----------------------- | --- | --- | ---------- | --- | ---------- | --- |

|     |     |     | (0.0011)  |     | (0.0007)  |     |
| --- | --- | --- | --------- | --- | --------- | --- |

| Durable goods  |     |     | -0.0001  |     | -0.0017***  |     |
| -------------- | --- | --- | -------- | --- | ----------- | --- |

|              |     |     | (0.0004)  |     | (0.0004)  |          |
| ------------ | --- | --- | --------- | --- | --------- | -------- |
| No. of obs.  |     |     | 77,701    |     |           | 235,046  |
Note: * p < 0.10, ** p < 0.05, *** p < 0.01
The average treatment effects on the treated (remittance-receiving households) is ran through a propensity
score matching (PSM) technique. The following variables are used to predict the treatment assignment in
the treatment model: total household expenditure (in natural log), region of residence, the composition of
male household members, the age of the household head, the marital status of the household head, the
composition of household members with post-secondary education, and family size. The 2018 and 2021
Family Income and Expenditure Surveys are used, and the survey year is controlled in the implementation
as well.
Source of basic data: Authors’ calculations; Philippine Statistics Authority.

Table 4. Descriptive Statistics of Independent Variables, Pooled Dataset, 2007 – 2022
Obs
...
Table 5. Determinants of Cash and Personal Remittances Sent by All Types of Overseas Filipino Workers, 2007 – 2022 (standard errors
in parenthesis)
...
Annex A
The Case of Binding Financial Constraints
While remittances may be perceived as a key driver of poverty reduction and welfare
improvement at an aggregate level (Cui et al., 2023; Azizi, 2019), our findings at the micro
level reveal that their impact on household consumption varies by economic status. This
variation may stem from whether households face binding financial constraints—limiting the
extent to which remittances can boost non-food human capital expenditures for poorer
households. Table A1 provides evidence supporting these claims.
INSERT TABLE A1
Our findings indicate that households receiving remittances tend to spend less on food and
durable goods while allocating more to education, health, clothing, and housing and utilities.
However, these shifts are less pronounced among poorer remittance-receiving households due
to financial constraints. For instance, the reduction in food expenditure share is smaller for
poorer households, and the increases in education, health, clothing, and housing and utilities
expenditures are more limited in magnitude.
We also examine the spillover effects of remittances on poor non-recipient households,
which can either reinforce or loosen their financial constraints. If spillovers reinforce financial
constraints, poor non-recipients may have to adjust their consumption patterns within a fixed
or shrinking budget, as their purchasing power declines. This could happen if remittance-driven
demand raises local commodity prices, making essential goods less affordable. If spillovers
loosen financial constraints, remittances may improve local economic conditions—such as
increasing job opportunities or wages—enabling poor households to raise their living standards
and diversify their spending. We test this in Table A2, where we use the density of remittance
receiving households in a province as a determinant of spillover effects.
INSERT TABLE A2
Classification: GENERAL

Determining whether spillover effects reinforce or alleviate households’ financial
constraints is not straightforward. One way to assess this is by examining how households
allocate their consumption toward food.
Our findings support the core financial constraint thesis: poor households continue to
allocate a larger share of their budget to food. However, the spillover effect on poor non-
recipient households suggests that those in high-remittance areas are reducing their food
expenditure share. This raises a key question: Is this reduction due to a loosening of financial
constraints, or are households merely reallocating within a tight budget?
To answer this, we test whether total consumption increases for poor non-recipient
households in high-remittance areas. The results in Table A2, Column (7) indicate that this is
not the case—poor non-recipients do not experience an overall rise in consumption. This
suggests that financial constraints remain binding, and the observed shift in spending is likely
a reallocation rather than an expansion of household resources.
Further, poor non-recipient households in high-remittance areas seem to allocate less to
education and housing and utilities, while the effect is insignificant for health. Households’
financial constraints remain binding for these important commodities.
Classification: GENERAL

Annex B
Alternative Specifications for the Determinants of Land- and Sea-based
Remittances
...
References
Cui, X., Umair, M., Gayratovich, G., Dilanchiev, A. (2023). Do remittances mitigate poverty?
An empirical evidence from 15 selected Asian economies. The Singapore Economic
Review, 68(4), 1447-1468. https://doi.org/10.1142/S0217590823440034.
Azizi, S. (2021). The impacts of workers’ remittances on poverty and inequality in developing
countries. Empirical Economics, 60, 969-991.
Classification: GENERAL

Table A1. How Financial Constraints Affect the Consumption Behavior of Remittance Receiving Households (standard errors in
parenthesis)
   Dependent variable: Consumption as share to total expenditure
|     |     |       |            |         |           |   Housing and  |                |
| --- | --- | ----- | ---------- | ------- | --------- | -------------- | -------------- |
|     |     | Food  | Education  | Health  | Clothing  |                | Durable goods  |
|     |     |       |            |         |           | utilities      |                |
|     |     | (1)   |   (2)      |   (3)   |   (4)     |   (5)          |   (6)          |
Remittance-receiving household  -0.0167***    0.00415***    0.00484***    0.00113***    0.0202***    -0.00105***
|     |     | (0.000471)  | (0.000182)  | (0.000245)  | (9.24e-05)  | (0.000468)  | (0.000284)  |
| --- | --- | ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |
|     |     |             |             |             |             |             |             |
Poor household  0.00957***  0.00363***  0.00277***  0.00187***  -0.0187***  0.000644**
|     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
  (0.000583)    (0.000166)    (0.000260)    (0.000103)    (0.000517)    (0.000328)
Remittance-receiving x poor household  0.00440***    -0.00426***    -0.00438***    -0.000178    -0.00812***    0.000854**
|     |     | (0.00108)  | (0.000276)  | (0.000361)  | (0.000193)  | (0.000895)  | (0.000425)  |
| --- | --- | ---------- | ----------- | ----------- | ----------- | ----------- | ----------- |
|     |     |            |             |             |             |             |             |
Total expenditures  -0.119***    0.00959***    0.0155***    0.00203***    -0.000573    0.0259***
(in natural log)  (0.000464)    (0.000180)    (0.000345)    (0.000109)    (0.000503)    (0.000433)
Male HH members  0.0113***  -0.00205***  -0.00632***  0.00205***  -0.0230***  0.00344***
|     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
  (0.000871)    (0.000260)    (0.000390)    (0.000148)    (0.000860)    (0.000409)
Age of household head  0.000900***    0.000719***    -0.000793***    -0.000205***    -0.000773***    -0.000189***
|     |     | (8.20e-05)  | (2.63e-05)  | (3.91e-05)  | (1.53e-05)  | (7.74e-05)  | (4.16e-05)  |
| --- | --- | ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |
|     |     |             |             |             |             |             |             |
Age of household head  -1.37e-05***  -7.39e-06***  1.23e-05***  8.53e-07***  1.50e-05***  1.02e-06***
|     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
(squared)  (7.79e-07)    (2.45e-07)    (3.96e-07)    (1.44e-07)    (7.46e-07)    (3.86e-07)
Household head is married  0.0122***    0.00199***    0.000396    0.000191    -0.00875***    0.00170***
|     |     | (0.000643)  | (0.000230)  | (0.000324)  | (0.000130)  | (0.000602)  | (0.000333)  |
| --- | --- | ----------- | ----------- | ----------- | ----------- | ----------- | ----------- |
|     |     |             |             |             |             |             |             |
HH members with post-secondary education  -0.0664***    0.0151***    -0.00423***    0.00370***    0.0434***    -0.0125***
  (0.000784)    (0.000293)    (0.000436)    (0.000161)    (0.000814)    (0.000466)
Family size  0.0198***  0.000134***  -0.00267***  -0.000204***  -0.00904***  -0.00217***
|     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
  (0.000118)    (4.03e-05)    (6.60e-05)    (2.28e-05)    (0.000111)    (7.96e-05)
| Region controls  |     | Yes  |   Yes  |   Yes  |   Yes  |   Yes  |   Yes  |
| ---------------- | --- | ---- | ------ | ------ | ------ | ------ | ------ |
| Year controls    |     | Yes  | Yes    | Yes    | Yes    | Yes    | Yes    |
|                  |     |      |        |        |        |        |        |
No. of obs.  312,747  312,747  312,747  312,747  312,747  312,747
|     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
R-squared  0.467     0.100     0.074     0.089     0.224     0.060
Note: * p < 0.1, ** p < 0.05, *** p < 0.01.
These results are run using a standard OLS model. While endogeneity is a usual issue in regressing consumption against any remittance indicator, the OLS results are consistent with the
findings in the average treatment effects model that addresses the endogeneity issue.
Source of basic data: Authors’ calculations; Philippine Statistics Authority.
|     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- |
...
Table A2. How Remittance Spillovers affect the Financial Constraints and Consumption Patterns of Non-recipient Households
(standard errors in parenthesis)
   Dependent variable: Consumption as share to total expenditure
|     |     |       |            |         |           |   Housing and  |                |   Log of Total  |
| --- | --- | ----- | ---------- | ------- | --------- | -------------- | -------------- | --------------- |
|     |     | Food  | Education  | Health  | Clothing  |                | Durable goods  |                 |
|     |     |       |            |         |           | utilities      |                | Expenditure     |
|     |     | (1)   |   (2)      |   (3)   |   (4)     |   (5)          |   (6)          |   (7)           |
|     |     |       |            |         |           |                |                |                 |
Remittance density  0.0434***  -0.0158***  -0.00314**  -0.00688***  -0.0140***  -0.00380*    0.0211*
|     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
(0.00280)  (0.000979)  (0.00160)  (0.000532)  (0.00280)  (0.00195)    (0.0127)

Non-recipient household  0.0337***  -0.00608***  -0.00574***  -0.000129  -0.0406***  0.00639***    -0.233***
|     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
  (0.00128)    (0.000440)    (0.000652)    (0.000235)    (0.00124)    (0.000827)    (0.00560)
Remittance density x non-recipient  -0.0544***    0.00404***    0.00272    -0.00509***    0.0728***    -0.0206***    0.397***
(0.00388)  (0.00125)  (0.00196)  (0.000714)  (0.00369)  (0.00256)    (0.0172)
|     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
Poor household  0.0230***    -0.00252***    -0.00288***    0.00188***    -0.0394***    0.00354***    -0.804***
  (0.00251)    (0.000634)    (0.000855)    (0.000432)    (0.00208)    (0.00104)    (0.00797)
Remittance density x poor household  -0.0256***  0.00555***  0.00392  -0.000701  0.0382***  -0.00620**    0.160***
|     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
  (0.00721)    (0.00166)    (0.00243)    (0.00124)    (0.00584)    (0.00288)    (0.0227)
Non-recipient x poor household  -0.000913    0.00567***    0.00367***    -0.00145***    0.0211***    -0.00759***    0.187***
(0.00273)  (0.000687)  (0.000921)  (0.000471)  (0.00225)  (0.00114)    (0.00899)
|     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
Remittance density x non-recipient x  -0.0289***  -0.00494**  0.00454  0.00552***  -0.0334***  0.0237***    -0.312***
|     |     |     |     |     |     |     |     |     |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
poor household  (0.00846)    (0.00198)    (0.00282)    (0.00147)    (0.00683)    (0.00349)    (0.0276)
Region controls  Yes    Yes    Yes    Yes    Yes    Yes    Yes
| Year controls  |     | Yes  | Yes  | Yes  | Yes  | Yes  | Yes  |   Yes  |
| -------------- | --- | ---- | ---- | ---- | ---- | ---- | ---- | ------ |
|                |     |      |      |      |      |      |      |        |
No. of obs.  312,747    312,747    312,747    312,747    312,747    312,747    312,747
R-squared  0.468     0.102     0.074     0.092     0.227     0.061    0.607
Note: * p < 0.1, ** p < 0.05, *** p < 0.01.
These results are run using a standard OLS model. While endogeneity is a usual issue in regressing consumption against any remittance indicator, the OLS results are consistent with the
findings in the average treatment effects model that addresses the endogeneity issue. The following variables are used as controls: total household expenditure (in natural log), region of
residence, the composition of male household members, the age of the household head, the marital status of the household head, the composition of household members with post-secondary
education, and family size. The 2018 and 2021 Family Income and Expenditure Surveys are used, and the survey year is controlled in the implementation as well.
Source of basic data: Authors’ calculations; Philippine Statistics Authority.
...
Table B1. Determinants of Cash and Personal Remittances Sent by Land-based and Sea-based Overseas Filipino Workers, 2007 –
2022 (standard errors in parenthesis)
Dependent variable  Cash remittances     Personal remittances
| (in natural log):          |     | (1)      | (2)      | (3)      | (4)      |   (1)      | (2)      | (3)      | (4)      |
| -------------------------- | --- | -------- | -------- | -------- | -------- | ---------- | -------- | -------- | -------- |
